/*
 extraction_init.sqf v1.12 by Jigsor
...
JIG_EX_Group_Dis	=	500;							// (WIP) Distance used to inventory group members of Evac caller within this range of Evac caller.//Chopper will not Leave Evac LZ until all human members in this range are in chopper (or chopper already filled with members, needs testing...).
