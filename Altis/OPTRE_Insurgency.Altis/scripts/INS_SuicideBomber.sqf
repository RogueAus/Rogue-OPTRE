...
private ["_delay","_ins_debug","_basePos","_safeZone_rad","_maxtype"];
...
"random_civ_bomber" addPublicVariableEventHandler {call compile format ["%1",_this select 1]}; //BWRDEBUG - draftee
